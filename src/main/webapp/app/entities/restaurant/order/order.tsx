            ...
            <tbody>
              {orderList.map((order, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <TextFormat type="date" value={order.datetime} format={APP_LOCAL_DATE_FORMAT} />
                  </td>
                  <td>
                    <TextFormat type="date" value={order.acceptanceDatetime} format={APP_LOCAL_DATE_FORMAT} />
                  </td>
                  <td>{order.status}</td>
